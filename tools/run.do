...
# Load project
  eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -GWRITE_NR=$1 -GREAD_NR=$2  -GWRITE_ORDER=$3 -GREAD_ORDER=$4 -GTEST_NAME=$6  -GSEED_VALUE=$7 -sva top
  eval vsim -novopt -quiet -coverage +code=bcesft +notimingchecks +nowarnTSCALE -GWRITE_NR=$1 -GREAD_NR=$2  -GWRITE_ORDER=$3 -GREAD_ORDER=$4 -GTEST_NAME=$6  -GSEED_VALUE=$7 -sva top
